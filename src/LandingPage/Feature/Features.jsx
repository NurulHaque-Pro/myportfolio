    ...
    return (
        <div className='py-16 border-b-2 border-[#121415] container mx-auto'>
            ...
            <div className='pt-10 grid md:grid-cols-3 gap-5'>
                ...
                >
                    <div className="card w-full bg-gradient-to-b from-base-200 h-full cursor-pointer shadow-xl hover:bg-gradient-to-t">
                ...
                <Tilt
                    ...
                    transitionSpeed={2500}
                >
                    <div className="card w-full bg-gradient-to-b hover:bg-gradient-to-t h-full cursor-pointer from-base-200 shadow-xl">
                        <div className="card-body">
